...
export default function Portfolio() {
  return (
    <div
      className="h-screen flex items-end flex-col justify-center"
...
const iconStyle = clsx(
  "my-4 lg:my-0 mx-2 max-h-[65px] lg:w-auto lg:max-w-[100px] lg:max-h-[70px]"
);
